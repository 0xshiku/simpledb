...
// Reads the contents of the specified block into the provided page.
...
// Writes the content of the provided page to the specified block.
...
func (fm *FileMgr) getFile(filename string) (*os.File, error) {
	...
	if !ok {
		...
		// This opens the file at the specified path with read and write permissions (os.RDWR),
